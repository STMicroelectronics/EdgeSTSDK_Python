...
docker build  --rm -f ./Dockerfile.arm32v7 -t stm32containerregistry.azurecr.io/mod_ew2020:0.3.1 . && docker push stm32containerregistry.azurecr.io/mod_ew2020:0.3.1
